...
screen = pygame.display.set_mode((WIDTH, HEIGHT)) # для поверхности

# заголовок
pygame.display.set_caption("Shmup!")
clock = pygame.time.Clock() # часы, отвечают за игровое время
...
background = pygame.image.load(path.join(img_dir, "img_1.png")).convert()
background_rect = background.get_rect()
player_img = pygame.image.load(path.join(img_dir, "ufoGreen.png")).convert()
